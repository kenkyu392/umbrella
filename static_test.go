...
func TestStatic(t *testing.T) {
	...
	testCases := []struct {
		...
		{pattern: "/static", code: http.StatusMovedPermanently, path: "/static", body: nil},
		{pattern: "/static/", code: http.StatusOK, path: "/static/", body: htmlData},
		{pattern: "/static/", code: http.StatusOK, path: "/static/js/app.js", body: jsData},
	}
