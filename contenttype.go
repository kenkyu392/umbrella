...
func AllowContentType(userAgents ...string) func(next http.Handler) http.Handler {
...
// the specified strings is included in the Content-Type header.
// Returns 415 Unsupported Media Type status if the request has a type that is not allowed.
func DisallowContentType(userAgents ...string) func(next http.Handler) http.Handler {
